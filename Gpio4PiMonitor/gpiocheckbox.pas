...
const
  ...
  // GPIO pins there are on the header: Gpio-0 to Gpio-27
  NumberHeaderPins = 28;
...
//  OnClick:= @GpioPinClick;   No clicks here
...
// -------------------------------------------------------------
// Return text for Pin ComboBox in MainForm
...
// -------------------------------------------------------------
// Return Hint for Pin ComboBox in MainForm
// Phys: Header Pin which corresponds to the ComboBox number
// -------------------------------------------------------------
function HintForPinCombo(Phys: Integer): String;
var
