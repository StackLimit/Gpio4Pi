...
const
  ...
  // Uart control bits for UART_CR register
  ...
  // Uart Line control bits for UART_LCRH register
  ...
  // Uart Flag bits for UART_FR register
  ...
  // Uart Error bits for Data Register UART-DR
